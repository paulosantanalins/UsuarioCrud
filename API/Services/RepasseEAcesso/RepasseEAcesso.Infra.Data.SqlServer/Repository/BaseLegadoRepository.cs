...
{
    public class BaseLegadoRepository<TEntity> : IBaseRepository<TEntity> where TEntity : EntityBase
    {
        protected DbSet<TEntity> DbSet;
        public readonly RepasseLegadoContext _context;
        private readonly IVariablesToken _variables;

        public BaseLegadoRepository(RepasseLegadoContext context, IVariablesToken variables)
        {
            _context = context;
